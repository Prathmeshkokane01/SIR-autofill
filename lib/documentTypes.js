...
export const DOCUMENT_TYPES = [
  ...
  },
  {
    ...
    required: false,
    label: { mr: "वडिलांच्या वडिलांचे जुने Voter ID (आजोबा)", hi: "पिता के पिता का पुराना Voter ID (दादा)", en: "Father's Father's Old Voter ID (Grandfather)" },
    hint: {
  ...
  },
  {
    ...
    required: false,
    label: { mr: "वडिलांच्या आईचे जुने Voter ID (आजी)", hi: "पिता की माता का पुराना Voter ID (दादी)", en: "Father's Mother's Old Voter ID (Grandmother)" },
    hint: {
  ...
  },
  {
    ...
    required: false,
    label: { mr: "आईच्या वडिलांचे जुने Voter ID (आजोबा)", hi: "माता के पिता का पुराना Voter ID (नाना)", en: "Mother's Father's Old Voter ID (Grandfather)" },
    hint: {
  ...
  },
  {
    ...
    required: false,
    label: { mr: "आईच्या आईचे जुने Voter ID (आजी)", hi: "माता की माता का पुराना Voter ID (नानी)", en: "Mother's Mother's Old Voter ID (Grandmother)" },
    hint: {
