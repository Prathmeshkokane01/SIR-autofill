...
export const FIELD_GROUPS = [
  ...
  {
    title: { mr: "आजी-आजोबांचे तपशील", hi: "दादा-दादी / नाना-नानी का विवरण", en: "Grandparents' Details" },
    fields: [
      { key: "paternalGrandfatherName", label: { mr: "वडिलांच्या वडिलांचे नाव (आजोबा)", hi: "पिता के पिता का नाम (दादा)", en: "Paternal Grandfather's Name" } },
      { key: "paternalGrandmotherName", label: { mr: "वडिलांच्या आईचे नाव (आजी)", hi: "पिता की माता का नाम (दादी)", en: "Paternal Grandmother's Name" } },
      { key: "maternalGrandfatherName", label: { mr: "आईच्या वडिलांचे नाव (आजोबा)", hi: "माता के पिता का नाम (नाना)", en: "Maternal Grandfather's Name" } },
      { key: "maternalGrandmotherName", label: { mr: "आईच्या आईचे नाव (आजी)", hi: "माता की माता का नाम (नानी)", en: "Maternal Grandmother's Name" } },
    ],
  },
];
