...
export const DOCUMENT_TYPES = [
  ...
  },
  {
    key: "spouse_voter_id",
    required: false,
    label: { mr: "पती/पत्नीचे जुने Voter ID/Aadhar Card (लागू असल्यास)", hi: "पति/पत्नी का पुराना Voter ID/Aadhar Card (लागू हो तो)", en: "Spouse's Old Voter ID/Aadhar Card (if applicable)" },
    hint: {
  ...
  {
    key: "paternal_grandfather_voter_id",
    required: false,
    label: { mr: "वडिलांच्या वडिलांचे जुने Voter ID/Aadhar Card (आजोबा)", hi: "पिता के पिता का पुराना Voter ID/Aadhar Card (दादा)", en: "Father's Father's Old Voter ID/Aadhar Card (Grandfather)" },
    hint: {
      mr: "उपलब्ध असल्यास अपलोड करा — वडिलांच्या वडिलांचे नाव भरण्यासाठी.",
      hi: "उपलब्ध हो तो अपलोड करें — पिता के पिता का नाम भरने के लिए.",
      en: "Upload if available — fills father's father's name.",
    },
  },
  {
    key: "paternal_grandmother_voter_id",
    required: false,
    label: { mr: "वडिलांच्या आईचे जुने Voter ID/Aadhar Card (आजी)", hi: "पिता की माता का पुराना Voter ID/Aadhar Card (दादी)", en: "Father's Mother's Old Voter ID/Aadhar Card (Grandmother)" },
    hint: {
      mr: "उपलब्ध असल्यास अपलोड करा — वडिलांच्या आईचे नाव भरण्यासाठी.",
      hi: "उपलब्ध हो तो अपलोड करें — पिता की माता का नाम भरने के लिए.",
      en: "Upload if available — fills father's mother's name.",
    },
  },
  {
    key: "maternal_grandfather_voter_id",
    required: false,
    label: { mr: "आईच्या वडिलांचे जुने Voter ID/Aadhar Card (आजोबा)", hi: "माता के पिता का पुराना Voter ID/Aadhar Card (नाना)", en: "Mother's Father's Old Voter ID/Aadhar Card (Grandfather)" },
    hint: {
      mr: "उपलब्ध असल्यास अपलोड करा — आईच्या वडिलांचे नाव भरण्यासाठी.",
      hi: "उपलब्ध हो तो अपलोड करें — माता के पिता का नाम भरने के लिए.",
      en: "Upload if available — fills mother's father's name.",
    },
  },
  {
    key: "maternal_grandmother_voter_id",
    required: false,
    label: { mr: "आईच्या आईचे जुने Voter ID/Aadhar Card (आजी)", hi: "माता की माता का पुराना Voter ID/Aadhar Card (नानी)", en: "Mother's Mother's Old Voter ID/Aadhar Card (Grandmother)" },
    hint: {
      mr: "उपलब्ध असल्यास अपलोड करा — आईच्या आईचे नाव भरण्यासाठी.",
      hi: "उपलब्ध हो तो अपलोड करें — माता की माता का नाम भरने के लिए.",
      en: "Upload if available — fills mother's mother's name.",
    },
  },
  {
