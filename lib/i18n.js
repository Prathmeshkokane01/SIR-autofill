...
export const STRINGS = {
  ...
  // Auth
  loginHeading: { mr: "लॉगिन करा", hi: "लॉगिन करें", en: "Log In" },
  signupHeading: { mr: "नवीन खाते तयार करा", hi: "नया खाता बनाएं", en: "Create an Account" },
  nameLabel: { mr: "पूर्ण नाव", hi: "पूरा नाम", en: "Full Name" },
  emailLabel: { mr: "ईमेल", hi: "ईमेल", en: "Email" },
  passwordLabel: { mr: "पासवर्ड", hi: "पासवर्ड", en: "Password" },
  loginBtn: { mr: "लॉगिन", hi: "लॉगिन", en: "Log In" },
  signupBtn: { mr: "खाते तयार करा", hi: "खाता बनाएं", en: "Create Account" },
  noAccountText: { mr: "खाते नाही? ", hi: "खाता नहीं है? ", en: "Don't have an account? " },
  haveAccountText: { mr: "आधीच खाते आहे? ", hi: "पहले से खाता है? ", en: "Already have an account? " },
  signupLink: { mr: "नवीन खाते तयार करा", hi: "नया खाता बनाएं", en: "Sign up" },
  loginLink: { mr: "लॉगिन करा", hi: "लॉगिन करें", en: "Log in" },
  logoutBtn: { mr: "लॉगआउट", hi: "लॉगआउट", en: "Log Out" },
  loggingInText: { mr: "Login होत आहे...", hi: "Login हो रहा है...", en: "Logging in..." },
  invalidLoginError: { mr: "ईमेल किंवा पासवर्ड चुकीचा आहे.", hi: "ईमेल या पासवर्ड गलत है.", en: "Invalid email or password." },

  // Submissions dashboard
  mySubmissionsLink: { mr: "माझे Submissions", hi: "मेरे Submissions", en: "My Submissions" },
  submissionsHeading: { mr: "माझे Submissions", hi: "मेरे Submissions", en: "My Submissions" },
  searchPlaceholder: { mr: "नाव किंवा EPIC क्रमांकाने शोधा...", hi: "नाम या EPIC नंबर से खोजें...", en: "Search by name or EPIC number..." },
  filterAll: { mr: "सर्व", hi: "सभी", en: "All" },
  filterDraft: { mr: "Draft", hi: "Draft", en: "Draft" },
  filterSubmitted: { mr: "Submitted", hi: "Submitted", en: "Submitted" },
  noSubmissionsText: { mr: "अजून काहीही submit झालेले नाही.", hi: "अभी तक कुछ भी submit नहीं हुआ.", en: "Nothing submitted yet." },
  noMatchText: { mr: "शोधाशी जुळणारे काहीही सापडले नाही.", hi: "खोज से मेल खाता कुछ नहीं मिला.", en: "Nothing matches your search." },
  downloadPdfLink: { mr: "PDF डाउनलोड करा", hi: "PDF डाउनलोड करें", en: "Download PDF" },
  deleteBtn: { mr: "Delete करा", hi: "Delete करें", en: "Delete" },
  deletingText: { mr: "Delete होत आहे...", hi: "Delete हो रहा है...", en: "Deleting..." },
  deleteConfirmText: {
    mr: "हे submission कायमचे delete होईल (database मधूनही). पुढे जायचे का?",
    hi: "यह submission हमेशा के लिए delete होगा (database से भी). आगे बढ़ें?",
    en: "This submission will be permanently deleted (from the database too). Continue?",
  },
  totalCountSuffix: { mr: "submissions", hi: "submissions", en: "submissions" },
};
